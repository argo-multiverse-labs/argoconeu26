...
pe "bat --style=plain -l yaml ../manifests/stage-3/applicationsets/tenant-onboarding.yaml"

p "# And here's the git directory structure:"
pe "ls -la ../tenants/"

p "# The platform-admin project allows deploying to any tenant-* namespace"
pe "yq '.spec | {\"destinations\": .destinations, \"namespaceResourceWhitelist\": .namespaceResourceWhitelist}' ../manifests/stage-3/projects/platform-admin-project.yaml"
...
pe "kubectl delete application -n argocd tenant-a tenant-b --ignore-not-found"
