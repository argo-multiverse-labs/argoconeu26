...
p "# The key field: spec.destinations — one namespace per tenant"

pe "yq '.spec | {\"destinations\": .destinations, \"sourceRepos\": .sourceRepos}' ../manifests/stage-2/projects/tenant-a-project.yaml"
...
p "# Empty destinations = nothing can deploy here"

pe "bat --style=plain -l yaml ../manifests/stage-2/projects/default-project-locked.yaml"
...
p "# Default policy: no access. Each tenant gets scoped permissions."

pe "yq '.data' ../manifests/stage-2/argocd-config/argocd-rbac-cm.yaml"
