...
pe "bat --style=plain -l yaml ../manifests/stage-4/argocd-config/argocd-cm.yaml"
...
pe "yq 'select(documentIndex == 0) | .rules' ../manifests/stage-4/rbac/impersonation-clusterrole.yaml"
...
p "# Network access is now tied to ServiceAccount identity, not just namespace"
